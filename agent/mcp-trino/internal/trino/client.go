...
// func (c *Client) GetStock() ([]map[string]interface{}, error) {
// 	// Execute the query with optional attribution headers
//     query := "SELECT t1.stock_symbol, t1.highest FROM hudi.default.vn30 AS t1 INNER JOIN hudi.default.coporate_action AS t2 ON t1.stock_symbol = t2.symbol WHERE t2.event_name = 'Trả cổ tức bằng tiền mặt'"
